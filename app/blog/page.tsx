...
import { useTheme } from "../context/ThemeContext"; // استدعاء ThemeContext
...
export default function BlogPage() {
  const { theme } = useTheme(); // جلب theme
      ...
      <div className="max-w-7xl mx-auto pt-32">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-10">
          ...
          <input
            ...
            className={`
              flex-1 rounded-lg py-3 px-4 text-sm font-semibold
              ${theme === "dark"
          ...
          <select
            ...
            className={`
              rounded-lg py-2 px-6 text-sm font-semibold
              ${theme === "dark"
        ...
        {/* Grid */}
        {loading ? (
          <p className="text-center">{theme === "dark" ? "Loading blogs..." : "Loading blogs..."}</p>
        ) : filtered.length === 0 ? (
